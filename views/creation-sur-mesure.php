<!-- Home Section -->
<section class="home-section bg-light-alpha-90 parallax-5 parallax-mousemove-scene" style="background-image: url(<?= URL ?>assets/images/motifs-bg.jpeg)" id="creation-banner">
    <div class="container d-flex align-items-center pb-100 pt-30 pt-sm-120 pb-sm-120">
                ...
                <div class="col-md-6 d-flex align-items-center mb-sm-60">
                    <div>
                        ...
                        <h1 class="hs-title-1 mb-30">
                            <span class="wow charsAnimIn" data-splitting="chars">Création de robe de mariée sur mesure à Roubaix</span>
                        </h1>
                        <p class="section-descr mb-50 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1.2s">
                            Faites réaliser vos plus beaux vêtements de fête : mariages, anniversaires, cérémonies, les Toiles 3C2R vous proposent des créations sur mesure
                        </p>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-xl-6 offset-xl-1 d-flex align-items-center mb-md-60 mb-sm-40">
                <div class="w-100">
                    ...
                    <p class="section-descr mb-50 mb-sm-30">
                        Il n’est pas toujours facile de trouver des vêtements qui répondent parfaitement à nos attentes, surtout pour les événements importants, dans les boutiques de prêt-à-porter. Que ce soit pour un mariage, une fête ou simplement une envie spéciale, je vous propose des créations couture sur mesure qui combleront vos vœux les plus chers. Les Toiles 3C2R ont déjà une certaine notoriété à ce sujet à Lannoy, Roubaix ou Lille.
                    </p>
                </div>
            </div>
            <!-- End Section Text -->
    ...
    <div class="container position-relative">
        <div class="row mt-6">
            ...
            <div class="col-lg-5 col-xl-5 d-flex align-items-center mb-md-60 mb-sm-40">
                <div class="w-100">
                    <h3 class="section-title mb-30 fs-20">
                        Des broderies personnalisées
                    </h3>
                    <p class="section-descr mb-0 mb-sm-30 fs-18">
                        En plus des créations couture sur mesure, je réalise également des broderies personnalisées. Que ce soit à partir d’une photo, d’une idée ou d’un dessin, je peux broder sur vos vêtements des motifs uniques qui ajoutent une touche personnelle et originale. Je crée également des écussons, des logos en textile pour les entreprises, ou des macarons personnalisés avec le nom et le prénom, parfaits pour les cadeaux ou pour personnaliser des vêtements et accessoires.
                        <br><br>
                        Mes broderies sont réalisées avec soin et précision. Que ce soit pour un projet personnel ou professionnel, chaque broderie est unique et répondra à vos attentes les plus spécifiques. Vous pouvez compter sur mon expertise et ma passion pour la broderie et couture pour sublimer vos vêtements et accessoires.
                        <br>
                        Pour découvrir toutes mes créations couture sur mesure comme mes broderies, contactez-moi.
                    </p>
                </div>
            </div>
            <!-- End Section Text -->
