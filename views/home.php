            ...
            <div class="col-lg-5 col-xl-5 d-flex align-items-center mb-md-60 mb-sm-40">
                <div class="w-100">
                    ...
                    <p class="section-descr mb-0 mb-sm-30 fs-18">
                        ...
                        <br><br>
                        Que vous souhaitiez apprendre les bases ou perfectionner vos techniques de couture, mes cours sont conçus pour vous. Grâce à une approche ludique et conviviale, chaque session devient un moment de partage et de découverte. Vous apprendrez à manier les machines à coudre, à choisir les bons tissus de couture, à utiliser les accessoires de couture indispensables. Venez découvrir la joie de créer vos propres vêtements et accessoires!
                    </p>
